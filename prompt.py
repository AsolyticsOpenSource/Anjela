...
SYSTEM_PROMPT_SHORT_REPLY = "Пиши короткі, креативні коментрі до постів в соціальних мережах. Твоя відповідь має бути короткою до 5 слів. За бажанням можеш використовувати емодзі, але не більше одного"